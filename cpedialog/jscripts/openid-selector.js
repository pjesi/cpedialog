//hacked from https://www.idselector.com
(function () {
    function gen_selector() {
        ...
        function log(msg) {
            if (window.console) {
                window.console.log('ID Selector: ' + msg);
            }
        }
        ...
        if (oidTb == null) {
            log('couldn\'t find openid input box');
            return;
        }
        ...
        if (window.idselector_target_id) {
            ...
            if (!target) {
                log("couldn't find element with id " + window.idselector_target_id);
            }
        }
        if (target) {
        ...
        forward.style.verticalAlign = "middle";
        ...
        s = nameTb.style;
        s.verticalAlign = 'middle';
        s.padding = '2px 2px 2px 20px';
        s.backgroundRepeat = 'no-repeat';
        s.backgroundPosition = '2px 2px';
        ...
        function Grid() {
            ...
            for (var j = 0; j < 4; j++) {
                this.tbody.appendChild(this.rows[j]);
            }
        ...
        function showPopup() {
            ...
            s.top = y + "px";
            s.display = 'block';
            s.height = (pbody.offsetHeight + 2) + "px";
        ...
        if (window.ActiveXObject) {
            ...
            document.body.parentNode.addEventListener('click', function(evt) {
                if (evt.target != oidTb && evt.target != btn) {
                    hidePopup();
                }
            }, false);
        }
